...
2. Kéo thả biểu tượng **MyOpenKey** vào thư mục **Applications**.
3. **Cấp quyền Trợ năng (Accessibility)**:
   - Vào **Cài đặt hệ thống (System Settings)** ➔ **Quyền riêng tư & Bảo mật (Privacy & Security)** ➔ **Trợ năng (Accessibility)**.
   - Bấm dấu `+`, chọn **MyOpenKey** trong thư mục Applications và bật công tắc cho phép.
4. Mở **MyOpenKey** và tận hưởng trải nghiệm gõ tiếng Việt mượt mà!
